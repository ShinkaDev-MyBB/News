...
$config['database']['database'] = 'shinkarp_mybb244';
$config['database']['table_prefix'] = 'mybbyl_';

$config['database']['hostname'] = 'localhost';
$config['database']['username'] = 'shinkarp_mybb244';
$config['database']['password'] = '-6Sv8M3pw-';
